...
from tiletime.plan import SplitParams, is_valid_frames
from tiletime.presets import CUSTOM, PRESETS, preset_labels, preset_widget_values
...
def test_widget_values_keyed_by_label():
    ...
    assert values["MiniMax H3 (32, 17k, 1280x704, 136/17)"] == {
